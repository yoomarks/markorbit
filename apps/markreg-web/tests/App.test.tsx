...
describe('guided intake', () => {
  it('routes completed Professional Review into the durable Documents and Preparation consumer', async () => {
    ...
    expect(
      screen.getByText(/pinned to that exact review version and decision fingerprint/i)
    ).toBeVisible();
