CREATE TABLE capability_reflection_candidates (
 reflection_candidate_id text PRIMARY KEY CHECK (reflection_candidate_id ~ '^reflection-candidate_[0-9a-f]{32}$'),
...
CREATE TABLE capability_reflection_candidate_ledger_entries (
 ...
 PRIMARY KEY (reflection_candidate_id, ledger_entry_id),
 UNIQUE (reflection_candidate_id, position)
);
