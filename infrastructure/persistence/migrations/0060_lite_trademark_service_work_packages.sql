...
-- Every version is retained because later requirement/readiness/execution-preparation
-- references must be able to point at the exact reviewed Product snapshot.
