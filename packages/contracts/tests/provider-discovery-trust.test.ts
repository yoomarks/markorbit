...
function trustContext(overrides: Record<string, unknown> = {}) {
  ...
  return {
    ...
    ...base,
    contextScopeFingerprintSha256: providerDiscoveryTrustContextScopeFingerprintV1(base)
  };
}
...
function comparisonFor(support: ReturnType<typeof availableSupport> | Record<string, unknown>) {
  ...
  return {
    ...base,
    generatedAt: AT,
    comparisonFingerprintSha256: providerDiscoveryTrustComparisonFingerprintV1(base as never)
  };
}
