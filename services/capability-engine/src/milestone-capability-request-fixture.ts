...
import { HttpError, json, type JsonResult, type JsonRoute } from '@markorbit/service-kit';
...
export interface MilestoneCapabilityRequestFixtureOptions {
  repository?: InMemoryCapabilityRequestRepository;
  publisher?: EventPublisher;
  now?: () => string;
}

export function createMilestoneCapabilityRequestFixtureRoute(
  options: MilestoneCapabilityRequestFixtureOptions = {}
): JsonRoute {
